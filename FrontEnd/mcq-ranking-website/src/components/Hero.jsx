...
function Hero() {
  return (
       <div className="relative w-350 h-90" style={{backgroundImage:`url(${hero})`,backgroundSize:"100% 370%", backgroundPosition:"right",
       backgroundRepeat:"no-repeat" }}>
            ...
            <p className="text-gray-300 mt-4">
                ...
                <div className="flex gap-4 mt-6">
                    <button className="bg-blue-500 rounded-full px-4 py-1 drop-shadow-[0_0_5px_rgba(1,88,118,0.8)] hover:drop-shadow-[0_0_10px_rgba(1,88,118,0.8)] hover:scale-105" >Start Practicing Now</button>
